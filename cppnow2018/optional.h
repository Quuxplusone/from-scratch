...
#include "enable-optional-smfs.h"
#include "in-place.h"
#include "nullopt.h"
#include "optional-storage.h"
#include "polyfill.h"
...
public:
    ...
    constexpr T& value() &               { assert(has_value()); return *(*this); }
    constexpr const T& value() const &   { assert(has_value()); return *(*this); }
    constexpr T&& value() &&             { assert(has_value()); return std::move(*(*this)); }
    constexpr const T&& value() const && { assert(has_value()); return std::move(*(*this)); }
