...
template<class T, class... Us>               struct is_constructible_impl<T, decltype(::new (declval<void*>()) T(declval<Us>()...), (void)0), Us...> : true_type {};

template<class T, class Enable, class... Us> struct is_nothrow_constructible_impl                                                                            : false_type {};
template<class T, class... Us>               struct is_nothrow_constructible_impl<T, decltype(::new (declval<void*>()) T(declval<Us>()...), (void)0), Us...> : bool_constant<noexcept(::new (declval<void*>()) T(declval<Us>()...))> {};

template<class T, class U, class Enable> struct is_assignable_impl                                                       : false_type {};
template<class T, class U>               struct is_assignable_impl<T, U, decltype(declval<T>() = declval<U>(), (void)0)> : true_type {};

template<class T, class U, class Enable> struct is_nothrow_assignable_impl                                                       : false_type {};
template<class T, class U>               struct is_nothrow_assignable_impl<T, U, decltype(declval<T>() = declval<U>(), (void)0)> : bool_constant<noexcept(declval<T>() = declval<U>())> {};
