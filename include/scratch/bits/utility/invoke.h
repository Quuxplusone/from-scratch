...
// - If is_base_of_v<B, decay_t<O>>, then INVOKE(f, o, args...) is equivalent to (o.*f)(args...)
// - Otherwise, if decay_t<O> is a specialization of reference_wrapper,
...
// - If is_base_of_v<B, decay_t<O>>, then INVOKE(f, o) is equivalent to (o.*f)
// - Otherwise, if decay_t<O> is a specialization of reference_wrapper,
...
template<class... Ts>               struct invoke_result_impl<enable_if_t<is_invocable_v<Ts...>>, Ts...> {
